...
# 2. KOSPI 200 핵심 기업 가나다순 대량 배열 (똘이종목과 중복 허용)
kospi_200_full = {
    ...
    "휘닉스소재": "050090", "흥국화재": "000540", "BGF리테일": "282330", "BNK금융지주": "138930", "CJ": "001040",
    ...
    "HL만도": "204320", "KINDEX200": "105190", "KODEX200": "069500", "KOSEF200": "069660", "K지주": "003550",
    "LF": "093050", "OCI홀딩스": "010060", "PAIK光": "002760", "TIGER200": "102110", "강원랜드": "035250",
    "고려아연": "010130", "고려제강": "002240", "금호석유": "011780", "금호타이어": "073240", "기아": "000270",
    "기업은행": "024110", "낙산": "000120", "남선알미늄": "008350", "남해화학": "025860", "넥센타이어": "002270",
    "넷마블": "251270", "농심": "004370", "누리플랜": "069140", "대덕전자": "353200", "대아티아이": "045390",
    "대우건설": "047040", "대우조선해양": "042660", "대한유화": "006650", "대한항공": "003490", "동국제강": "001230",
    ...
    "미래에셋증권": "006800", "보령": "003850", "부광약품": "003000", "빙그레": "005180", "삼성가드": "029780",
    "삼성물산": "028260", "삼성바이오로직스": "207940", "삼성생명": "032830", "삼성SDI": "006400", "삼성SE": "028050",
    "삼성엔지니어링": "028050", "삼성전기": "009150", "삼성전자": "005930", "삼성중공업": "010140", "삼성증권": "016360",
    "삼성화재": "000810", "삼양홀딩스": "000070", "삼양식품": "003230", "상방": "002240", "서연": "007860",
    "서울가스": "017390", "선진": "143000", "성신양회": "000450", "세방전지": "004490", "셀트리온": "068270",
    "솔루스첨단소재": "336370", "신세계": "004170", "신한지주": "055550", "아모레퍼시픽": "090430", "아모레G": "002790",
    "아시아나항공": "020560", "에스원": "012750", "에스오일": "010950", "에코프로머티": "450080", "엘앤에프": "066970",
    "영원무역": "111770", "오리온": "271560", "우리금융지주": "316140", "유한양행": "000100", "이마트": "139480",
    "일진하이솔루스": "271940", "제일기획": "030000", "종근당": "185750", "카카오": "035720", "카카오뱅크": "323410",
    "카카오페이": "377300", "하이트진로": "000080", "한전KPS": "051600", "한전기술": "052690", "한화시스템": "272210"
}
...
# ==============================================================================
with main_tabs[0]:
    # 🌟 '현광판' => '현황판' 명칭 전면 수정 및 KR/US 국기 문구 싹 제거
    ...
    # 🌟 주요 보정 사항: 필터링 셀렉터 -> '종목별 분석' 타이틀 변경 및 똘이선택종목 / KOSPI200 그룹화
    st.markdown("##### 🔍 종목별 분석")
    ...
    if group_choice == "똘이선택종목":
        ...
        # 가나다순으로 정렬된 코스피 200대 기업 드롭다운 바인딩
        ...
        with st.spinner("퀀트 가중치 변수 연산 중..."):
            try:
                ...
                if len(rows) < 20:
                    ...
                    # 실시간 개장 시점 판단 시스템 (장 마감후엔 전일 종가 표기 알림 주입)
                    ...
                    # 🌟 줄정렬 및 예쁜 고정폭 소형 박스로 리포트 룸 피날레 셋업
                    st.markdown(f"""
