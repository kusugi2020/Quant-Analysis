...
st.markdown("""
    <div style="background-color:#0F172A; padding:24px; border-radius:12px; margin-bottom:25px; border-left: 8px solid #3B82F6;">
        ...
        <p style="color:#94A3B8; margin:8px 0 0 0; font-size:15px;">오늘 가격 기준으로 살지 말지, 얼만큼 떨어질때 사야 할 지 몰라서 AI와 통계 데이터를 비벼서 만들었습니다.</p>최근 20일 간 하락율이 10%면 이격도 90%이며, 90%든 85%든 본인이 몇 % 떨어면 사볼만 하겠다 했을 때 과거 통계를 기반으로 수익에 성공할 확률과 보유기간별 수익률을 예상해 보는 사이트입니다.
    </div>
